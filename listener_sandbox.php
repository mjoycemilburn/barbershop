...
$my_email_addresses = array("paypal@applebyarchaeology.org.uk", "mjoycemilburn@applebyarchaeology.org.uk"); //**CONFIG REQUIRED**
...
if ($verified) {
    ...
    if ($receiver_email_found) {
        ...
        $url = "https://applebyarchaeology.org.uk/ecommerce_admin/booker/php/process_paypal_consequentials.php"; //**CONFIG REQUIRED**
        $ch2 = curl_init();
...
// the account address to tell us what's going on (note this is essentially a debuggin_only
// arrangement - you'd remove this for live operation)

$mailing_address = "mjoycemilburn@gmail.com"; //**CONFIG REQUIRED**
