...
// the & characters were being transmitted as html entities (&amp;) - but never really
...
$shop_name = $pieces[6];
$number_of_slots_per_hour = $pieces[7];

// get the stylist-assignment for the appointment. Note we have a unique reference number so don't
// need to include shop-code etc in the search parameters
