...
$my_email_addresses = array("your_email_addresses"); //**CONFIG REQUIRED**
...
if ($verified) {
    ...
    if ($receiver_email_found) {
        ...
        $url = "your_url/booker/php/process_paypal_consequentials.php"; //**CONFIG REQUIRED**
        $ch2 = curl_init();
...
$mailing_address = "your_email_address"; //**CONFIG REQUIRED**
